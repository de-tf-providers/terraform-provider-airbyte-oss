...
// AirbyteOss - Airbyte Configuration API: Airbyte Configuration API
...
type SDKOption func(*AirbyteOss)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *AirbyteOss) {
...
func New(opts ...SDKOption) *AirbyteOss {
	sdk := &AirbyteOss{
		sdkConfiguration: sdkConfiguration{
			Language:          "terraform",
